...
const Sidebar = () => {
  ...
  return (
    <div className={`h-screen bg-gray-900 text-white flex flex-col ${isCollapsed ? "w-20" : "w-64"} transition-all duration-300`}>
      {/* Logo & Toggle Button */}
      <div className="flex items-center justify-between p-4">
        {!isCollapsed && <h1 className="text-lg font-bold">Project Manager</h1>}
      ...
      <nav className="flex flex-col gap-4 mt-4 px-4">
        ...
        <Link to="/projects" className="flex items-center gap-2 hover:bg-gray-700 p-2 rounded"
        title="Projects">
      ...
      <div className="mt-auto p-4">
        <button className="flex items-center gap-2 w-full hover:bg-red-600 p-2 rounded"
        title="Logout">
